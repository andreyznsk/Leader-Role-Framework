...
Единый реестр Change Requests. Обновлять при создании каждого нового CR.

> Формат строки: `Номер CR | Файл | Статус | Дата`
> При коллизии номеров — отметить `⚠️` в колонке CR.
...
| CR-MEM-035        | [2026-07-13_CR-MEM-035-create-jira-issue-from-today-task.md](2026-07-13_CR-MEM-035-create-jira-issue-from-today-task.md) | Draft | 2026-07-13 |
...
| CR | Файл | Статус | Дата |
|---|---|---|---|
| CR-MAIL-003 | [CR-MAIL-003-memory-delivery-error-retry.md](CR-MAIL-003-memory-delivery-error-retry.md) | Draft | — |
| CR-MAIL-004 | [CR-MAIL-004-ews-test-connection-auth-types.md](CR-MAIL-004-ews-test-connection-auth-types.md) | Draft | — |
| CR-MAIL-004 ⚠️ | [CR-MAIL-004-plugin-control-api.md](CR-MAIL-004-plugin-control-api.md) | Implemented | — |
| CR-MAIL-005 | [2026-06-29_CR-MAIL-005-intelligent-mail-linking.md](2026-06-29_CR-MAIL-005-intelligent-mail-linking.md) | In Progress / Partially Implemented | 2026-06-29 |
| CR-MAIL-BUGFIX-001 | [CR-MAIL-BUGFIX-001-draft-classification.md](CR-MAIL-BUGFIX-001-draft-classification.md) | Draft | — |
| CR-MAIL-BUGFIX-002 | [CR-MAIL-BUGFIX-002-noise-not-marked-read.md](CR-MAIL-BUGFIX-002-noise-not-marked-read.md) | Draft | — |
| CR-MAIL-BUGFIX-003 | [CR-MAIL-BUGFIX-003-capture-text-not-original.md](CR-MAIL-BUGFIX-003-capture-text-not-original.md) | OPEN | — |
...
| CR | Файл | Статус | Дата |
|---|---|---|---|
| CR-ARCH-001 | [CR-ARCH-001-master-update.md](CR-ARCH-001-master-update.md) | Implemented | — |
| CR-ARCH-002 | [CR-ARCH-002-e2e-testing.md](CR-ARCH-002-e2e-testing.md) | Approved | — |
| CR-ARCH-002 ⚠️ | [CR-ARCH-002-memory-as-agent-core.md](CR-ARCH-002-memory-as-agent-core.md) | Draft | — |
| CR-ARCH-003 | [CR-ARCH-003-update-docs-for-common.md](CR-ARCH-003-update-docs-for-common.md) | Approved | — |
| CR-ARCH-004 | [CR-ARCH-004-agent-v2.md](CR-ARCH-004-agent-v2.md) | Approved | — |
