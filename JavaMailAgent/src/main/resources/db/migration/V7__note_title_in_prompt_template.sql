UPDATE mailagent.prompt_templates
SET template = $$Ты — ассистент Tech Lead. Проанализируй входящее письмо и верни JSON.
...
$$,
updated_at = now()
WHERE code = 'classificationPrompt'
  AND template = $$Ты — ассистент Tech Lead. Проанализируй входящее письмо и верни JSON.
