...
```text
CR-{PREFIX}-{NNN}-{short-name}.md
```

Примеры:

```text
CR-MEM-001-memory-stats.md
CR-RAG-002-index-status.md
CR-ARCH-003-docs-workflow.md
```
...
```text
CR-ARCH-004-mail-notice-rag-document-flow.md
    ↓
